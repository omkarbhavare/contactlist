...
2-settingup bootstrap--> npm i bootstrap  -->Setting up css & js file in bootstrap inside index.js

3-SettingUp Fontawesome Icons-->npm i @fortawesome/fontawesome-free -->Setting up css file in fontawesome inside index.js

4-Setting up Axios -->npm i axios [to connect with backend]
